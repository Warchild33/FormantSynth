...
class FMSynth : public Syntezer
{
    Q_OBJECT
public:
    typedef double (*algoFun)(FmParams* p, double t, int n, bool bReleaseNote, double key_time);
    ...
    bool   bShowOSC;
    int    n_op_osc;
    algoFun algoFuncs[33];
    double algotest(FmParams* p, double t);
    static double algo1(FmParams* p, double t, int n, bool bReleaseNote, double key_time);
    static double algo19(FmParams* p, double t, int n, bool bReleaseNote, double key_time);
    static double algo5(FmParams* p, double t, int n, bool bReleaseNote, double key_time);
    static double algo17(FmParams* p, double t, int n, bool bReleaseNote, double key_time);
    static double algo16(FmParams* p, double t, int n, bool bReleaseNote, double key_time);
    static double algo32(FmParams* p, double t, int n, bool bReleaseNote, double key_time);
    static double algo2(FmParams* p, double t, int n, bool bReleaseNote, double key_time);
    static double algo3(FmParams* p, double t, int n, bool bReleaseNote, double key_time);
